...
public abstract class DrainBlock extends ModBlock implements EntityBlock {

    public DrainBlock(Properties properties, String registry) {
        super(properties);
    }
    ...
    public InteractionResult use(BlockState state, Level worldIn, BlockPos pos, Player player, InteractionHand handIn, BlockHitResult hit) {
        if (!worldIn.isClientSide && handIn == InteractionHand.MAIN_HAND) {
            if (worldIn.getBlockEntity(pos) instanceof AbstractDrainMachine tile) {
                /* //for implenting interract with bucket
