package com.pyroshiv.arsabyssaux.common.datagen;

import com.pyroshiv.arsabyssaux.ArsAbyssaux;
import net.minecraft.data.DataGenerator;
import net.minecraftforge.data.event.GatherDataEvent;
import net.minecraftforge.eventbus.api.SubscribeEvent;
import net.minecraftforge.fml.common.Mod;

@Mod.EventBusSubscriber(modid = ArsAbyssaux.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class Setup {
